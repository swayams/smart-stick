...
public class SmartPhidgetStick extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//start at the beginning as user moves the joystick
...
//						runOnUiThread(handler);
						...
						if(voltageRatioChangeEvent.getVoltageRatio() < 0.05) {
...
//		float z = 0;
			...
			try{
				...
				//set position of servomotor from the gyroscope
//				ch3.setTargetPosition(x);
//				ch3.setTargetPosition(y);
//				ch3.setTargetPosition(z);
